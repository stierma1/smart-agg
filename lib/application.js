...
Application.prototype.deleteAggregationRule = function(id){
  this.aggRuleProcessor.deleteRule(id);
}
...
Application.prototype.serializeRules = function(){
  return JSON.stringify(this.aggRuleProcessor.database.rules, null, 2);
}

Application.prototype.loadRules = function(jsonStringRules){
  this.aggRuleProcessor.database.rules = JSON.parse(jsonStringRules);
}

Application.prototype.serializeCurrentData = function(){
  return JSON.stringify(this.aggRuleProcessor.database.currentData, null, 2);
}

Application.prototype.loadCurrentData = function(jsonStringData){
  this.aggRuleProcessor.database.currentData = JSON.parse(jsonStringData);
}
