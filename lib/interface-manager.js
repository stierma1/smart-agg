...
InterfaceManager.prototype.addProtocolAdapter = function(protocolAdapter){
  var self = this;
  var protocol = protocolAdapter.protocol;
  this.protocolAdapters[protocol] = protocolAdapter;

  var config = _.extend(protocolAdapter.defaults || {}, this.config.protocols[protocol] || {});
